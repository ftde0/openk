...
var GenericAvatar =  new Class({
  ...
  load_options : function() {
    ...
    /*this.add_option(new AvatarOptionSendDzienKobiet2010Card(this.user_data.id));
    this.add_option(new AvatarOptionSendDzienKobiet2010Roses(this.user_data.id));*/
  ...
  get_photo : function() {
    ...
    photo_href.grab( new Element('img' ,{
      ...
      'src'   : this.user_data.photo_uri || getStaticUri('/img/brakzdjecia.gif')
    }));
  ...
  get_mail_button : function() {
    ...
    mail_button.grab(new Element('img', {
      ...
      'src' : getStaticUri('/img/avatar_mail.gif')
    }));
    return mail_button;
  },
  ...
  get_friends_button : function() {
    ...
    friends_button.grab(new Element('img', {
      'src' : getStaticUri('/img/ico_friends.gif')
    }));
  ...
  get_options_button : function() {
    ...
    options_button.grab(new Element('img', {    
      'src' : getStaticUri('/img/avatar_arrow.gif'),
      'alt' : 'Rozwiń'
    }))
