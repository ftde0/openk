...
var Widget = new Class({
  ...
  get_header : function () {
    ...
    tools.grab(new Element('img', {'src' : getStaticUri('/img/widgets/widget_tool')}));
    var hider =  new Element('span', {'class' : 'show_hide_content', events : {
      click : this.toggle.bind(this)
    }});
    hider.grab(new Element('img', {'src' : getStaticUri('/img/widgets/widget_arrow')}));
...
var PrzypominaczWidget = new Class({
  ...
  draw_items : function() {
    ...
    for (var i = 0; i < items_count; i++) {
      ...
      var icon =  new Element('img', {'src' : getStaticUri('/img/widgets/partners/przypominacz_ico_' + data['value']), 'class' : 'przypominacz_ico'});
      ...
      if ((data['value'] == 1 || data['value'] == 2) && !group_namedays) {
        ...
        var gift_nk = new Element('img', {'src' : getStaticUri('/img/widgets/partners/przypominacz_gift')});
        var gift_poczta = new Element('img', {'src' : getStaticUri('/img/widgets/partners/przypominacz_gift_poczta')});
