...
c["total"+h]=c[g]+c["total"+h];delete c["computed"+h];},this);return $extend(e,c);}});(function(){var a=false;window.addEvent("load",function(){var b=new Element("div").setStyles({position:"fixed",top:0,right:0}).inject(document.body);
